...
**Exabeam CIM Documentation Search**

**Common Information Model Retrieval Augmented Generation System**

## Overview

EXABOMINATION is a Retrieval Augmented Generation (RAG) system designed to make Exabeam's Common Information Model (CIM) documentation accessible and useful. By combining vector search technology with large language models, EXABOMINATION allows users to ask natural language questions about Exabeam CIM and receive accurate, contextual answers without needing to navigate through thousands of pages of documentation.
...
EXABOMINATION uses a modular architecture consisting of:
...
1. **Document Processing Pipeline**: 
   ...
   - Two different models for natural language and structured data embeddings.
